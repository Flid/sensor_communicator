...
class Workout(object):
    ...
    :param privacy_workout: Workout privacy.
           See: ``PRIVACY_PUBLIC``, ``PRIVACY_FRIENDS``, and ``PRIVACY_PRIVATE``
    :param privacy_map: Workout track privacy.
           See: ``PRIVACY_PUBLIC``, ``PRIVACY_FRIENDS``, and ``PRIVACY_PRIVATE``
    ...
    :param device: Divide understanding of workout.
           When new workout is created, app creates own
           ID for it for what it then tries to request
    """
